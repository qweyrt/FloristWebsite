...
export default {
  ...
  computed: {
    ...
    heroTitle() {
      return this.isProfileExists ? this.form.message : "Create Bouquet Message";
    },
    heroRouterLinkTo() {
      return this.isProfileExists ? { name: "bouquetMessages.new" } : { name: "home" };
    },
    heroRouterLinkLabel() {
      return this.isProfileExists ? "New Bouquet Message" : "Dashboard";
    },
    formCardTitle() {
      return this.isProfileExists ? "Edit Bouquet Message" : "Create Bouquet Message";
    },
